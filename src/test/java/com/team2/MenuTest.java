...
public class MenuTest {
    ...
    public void testmodeSoloTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et renvoyé 1 ", DictionnaireDeMotFactory.TypeMode.Solo, menu.selectMode());
    }
    ...
    public void testmodeSoloFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre vrai et renvoyé 2 ", DictionnaireDeMotFactory.TypeMode.Solo,
                menu.selectMode());
    }
    ...
    public void testmodeMultiTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et renvoyé 1 ", DictionnaireDeMotFactory.TypeMode.Multi,
                menu.selectMode());
    }
    ...
    public void testmodeMultiFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre vrai et renvoyé 2 ", DictionnaireDeMotFactory.TypeMode.Multi,
                menu.selectMode());
    }
    ...
    public void testdemandeJeuNormalTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et renvoyé type Normal ", DictionnaireDeMotFactory.TypeJeu.Normal,
                menu.demandeJeu());
    }
    ...
    public void testdemandeJeuTorduTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et type tordu ", DictionnaireDeMotFactory.TypeJeu.Tordu,
                menu.demandeJeu());
    }
    ...
    public void testdemandeJeuNormalFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre faux et renvoyé type tordu ", DictionnaireDeMotFactory.TypeJeu.Normal,
                menu.demandeJeu());
    }
    ...
    public void testdemandeJeuTorduFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre faux et renvoyé type normal ", DictionnaireDeMotFactory.TypeJeu.Tordu,
                menu.demandeJeu());
    }
    ...
    public void testdemandeDictListTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et renvoyé type Normal ", DictionnaireDeMotFactory.TypeListe.Liste,
                menu.demandeEndroitDictionnaire());
    }
    ...
    public void testdemandeDictFichierTrue() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertEquals("Le test doit etre vrai et type tordu ", DictionnaireDeMotFactory.TypeListe.Fichier,
                menu.demandeEndroitDictionnaire());
    }
    ...
    public void testdemandeDictListeFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre faux et renvoyé type tordu ", DictionnaireDeMotFactory.TypeListe.Liste,
                menu.demandeEndroitDictionnaire());
    }
    ...
    public void testdemandeDictFichierFalse() {
        ...
        System.setIn(inContent);
        final Menu menu = new Menu();
        assertNotEquals("Le test doit etre faux et renvoyé type normal ", DictionnaireDeMotFactory.TypeListe.Fichier,
                menu.demandeEndroitDictionnaire());
    }
